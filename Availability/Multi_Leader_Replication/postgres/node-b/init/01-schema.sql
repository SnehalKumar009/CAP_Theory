-- NODE B schema (runs once on first init).
-- Even-numbered ids so normal writes on the two leaders never collide on the PK.
CREATE ROLE repl_user WITH REPLICATION LOGIN PASSWORD 'repl_password';

CREATE SEQUENCE records_id_seq START 2 INCREMENT 2;
